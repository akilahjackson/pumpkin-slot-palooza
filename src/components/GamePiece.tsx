  ...
  return (
    <div
      ...
      className={cn(
        ...
        isMatched && isWild ? "animate-[flash_1s_ease-in-out_infinite] bg-yellow-500/30" : 
        isMatched ? "animate-[glow_1s_ease-in-out_infinite] bg-amber-500/30" : 
    ...
    >
      <span 
        className={cn(
          ...
          isMatched && "animate-[bounce_0.5s_ease-in-out_infinite]",
