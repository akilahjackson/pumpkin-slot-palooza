  ...
  return (
    <div
      className={cn(
        ...
        isMatched && isWild ? "animate-piece-flash" : isMatched ? "animate-pulse bg-amber-500" : "bg-amber-900/20 backdrop-blur-sm",
    ...
    >
      <span 
        className={cn(
          ...
          "rounded-lg p-2",
          isMatched ? "text-white scale-105" : "bg-amber-400/5",
